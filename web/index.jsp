<%-- 
    Document   : index
    Created on : Apr 16, 2024, 10:07:30 AM
    Author     : VIMAL SUKU
--%>
...
<html>
    ...
    <body>
        ...
        <div class="hotels_section layout_padding">
            <div class="search_bt"><a href="#bookHotel" data-toggle="modal">Book Hotels</a></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="hotels_taital">Hotels</h1>
                    </div>
                </div>
                <div class="hotels_section_2">
                    <div class="row">
                        <c:forEach var="hotel" items="${listOfHotel}">
                            <div class="col-md-4 my-3">
                                <div class="box_main">
                                    <div class="image_1"><img src="${hotel.hotelImageLoc}"></div>
                                    <h4 class="prid_text">${hotel.hotelName}</h4>
                                    <p class="korem_text">${hotel.hotelDescription}</p>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
        ...
        <!-- Hotel Book Modal HTML -->

        <div id="bookHotel" class="modal fade">
                    ...
                    <form action="Booking" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="check-in" name="checkInDate" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Check-out</label>
                                <input type="date" id="check-out" name="checkOutDate" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>No. of rooms</label>
                                <input type="text" name="noOfRooms" class="form-control" required>
                            </div>
                            <input type="hidden" name="action" value="hotelBook">
                        </div>
