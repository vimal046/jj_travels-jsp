<%-- 
    Document   : top-destination
    Created on : Apr 16, 2024, 10:07:57 AM
    Author     : VIMAL SUKU
--%>
...
<html>
    ...
    <head>
        ...
        <!-- fonts -->
        <link
            href="https://fonts.googleapis.com/css?family=Baloo+Chettan+2:400,500,600,700|Poppins:400,600,700&display=swap"
            rel="stylesheet">
        <!-- font awesome css-->
    ...
    <body>
        ...
        <div class="hotels_section layout_padding">
            <div class="search_bt"><a href="#enquireDestination" data-toggle="modal">Enquiry</a></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="hotels_taital">Top Destinations</h1>
                    </div>
                </div>
                <div class="hotels_section_2">
                    <div class="row">
                        <c:forEach var="dest" items="${listOfDest}">
                            <div class="col-md-4 my-3">
                                <div class="box_main">
                                    <div class="image_1"><img src="${dest.destImageLoc}"></div>
                                    <h4 class="prid_text">${dest.destName}</h4>
                                    <p class="korem_text">${dest.destDescription}</p>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
        ...
        <div id="enquireDestination" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="Booking" method="post">
                        <div class="modal-header">
                            <h4 class="modal-title">Enquire Destination</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="travellerCount" class="form-control" required min="1">
                            </div>
                            <div class="form-group">
                                <label>Message</label>
                                <textarea class="form-control" name="message" required></textarea>
                            </div>
                            <input type="hidden" name="action" value="destBook">
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="dummy_text">No.1, Gemini Parson Complex,Kodambakkam High Road, Tirumurthy
                            Nagar,Nungambakkam, Chennai,Tamil Nadu, India – 600006</p>
